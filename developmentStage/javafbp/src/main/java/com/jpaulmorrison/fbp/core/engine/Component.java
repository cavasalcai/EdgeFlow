...
//import com.jpaulmorrison.fbp.core.engine.Component.InputStates;
...
public abstract class Component extends Thread {
  ...
  private int WCET = 0; // add the execution time for the current component
  ...
  /**
  *  Set the WCET for the current component
  */
  protected void setWCET(int wcet){
      this.WCET = wcet;
  }
