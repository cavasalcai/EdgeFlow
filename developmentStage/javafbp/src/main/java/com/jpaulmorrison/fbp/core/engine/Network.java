...
public abstract class Network extends Component {
  ...
  // add here a property for the lists of a flow constraints. It has two parts, the flow <string, int>. Add setter and getter
  ...
  /**
   *  Stores the Component class object with its network name in the Hashtable
   *  called 'components', adding the WCET of the components as well.
   */
  protected final Component component(final String nme, final Class tpe, int wcet) {
      Component base_comp = this.component(nme, tpe);
      base_comp.setWCET(wcet);
      return base_comp;
  }
  ...
  */
  ...
  /* (non-Javadoc)
   * @see com.jpaulmorrison.fbp.core.engine.Component#terminate(com.jpaulmorrison.fbp.core.engine.Component.StatusValues)
   */
  @Override
