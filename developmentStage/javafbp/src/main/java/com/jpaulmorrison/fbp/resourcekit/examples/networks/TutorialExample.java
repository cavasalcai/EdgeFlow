...
public class TutorialExample extends Network {
String description = "Click anywhere on selection area";
protected void define() { 
  component("Read___Sample_File",com.jpaulmorrison.fbp.core.components.io.ReadFile.class); 
  component("filter_by_first_letter",com.jpaulmorrison.fbp.core.components.text.StartsWith.class); 
  component("display____accepted__lines",com.jpaulmorrison.fbp.core.components.swing.ShowText.class); 
